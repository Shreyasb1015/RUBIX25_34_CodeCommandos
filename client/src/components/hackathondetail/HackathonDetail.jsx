...
import { FaCalendar, FaClock, FaLaptop, FaTrophy, FaCode, FaUsers } from 'react-icons/fa';
  ...
  return (
    <div className={`hackathon-detail ${theme}`}>
      ...
      <div className="content-wrapper">
        ...
        >
          <img src={hackathon.bannerImage} alt={hackathon.name} className="banner-image" />
        </motion.div>
        ...
        <div className="details-container">
          ...
          >
            <div className="info-card">
              ...
              <div>
                <h3>Timeline</h3>
                <p>{new Date(hackathon.startingDate).toLocaleDateString()} - {new Date(hackathon.endingDate).toLocaleDateString()}</p>
              </div>
            </div>
