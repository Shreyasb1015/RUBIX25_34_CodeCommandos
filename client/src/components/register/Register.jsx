...
import { FaUser, FaEnvelope, FaLock, FaKey, FaLaptopCode } from 'react-icons/fa';
import registerpic from '../../assets/register-gif.gif';
import './Register.css';
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(SIGNUP_ROUTE, formData,{withCredentials:true});
        ...
        <div className="register-form-container">
          <form className="register-form" onSubmit={handleSubmit}>
            <div className="register-form-header">
              ...
              >
                <FaLaptopCode className="register-title-icon" /> Register
              </motion.h2>
            </div>
